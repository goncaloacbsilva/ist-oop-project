...
abstract class StockOperation {
    ...
    final void executeAgregationWithoutTransaction(String partnerId, String productId, int amount) throws UnknownObjectKeyException, NotEnoughResourcesException {
        Partner partner = _store.getPartner(partnerId);
        Product product = _store.getProduct(productId); 
    ...
    abstract void processAgregation(Partner partner, Product product) throws UnknownObjectKeyException, NotEnoughResourcesException;
